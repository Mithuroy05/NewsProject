        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    ?>
                  <h2 class="page-heading"><?php echo $search_value; ?></h2>
                  ...
                  <?php
                            ...
                            WHERE post.title LIKE '%{$search_value}%' OR post.description LIKE '%{$search_value}%'
                    ...
                    <div class="post-content">
                        ...
                        <!-- End of new report -->
                            ...
                            <!-- Start pagination -->
                        <?php
                            $queryForPage = "SELECT * FROM post WHERE title LIKE '%{$search_value}%' OR description LIKE '%{$search_value}%';";
                            ...
                            if(mysqli_num_rows($pageResult) > 0){
                                ...
                                echo '<ul class="pagination admin-pagination">';
                                    if($page > 1){
                                        echo '<li> <a href="search.php?search_id='.$search_value.'&page='.($page - 1).'"><</a></li>';
                                    }
                                for($i=1; $i<=$totalPage; $i++){
                                    ...
                                    echo '<li class="'.$active.'"><a href="search.php?search_id='.$search_value.'&page='. $i. ' "> '. $i. '</a></li>' ;
