            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                    <?php
                        ...
                        $headingSql = "SELECT first_name, last_name  FROM user WHERE user_id = {$auth_id};";
                        $headingResult = mysqli_query($conn, $headingSql) or die("Query Failed");
                        $headingRow = mysqli_fetch_assoc($headingResult);


                    ?>
                  <h2 class="page-heading"><?php echo $headingRow['first_name'].' '.$headingRow['last_name']; ?></h2>
                  ...
                  <?php
                    ...
                    <div class="post-content">
                        ...
                        <!-- End of new report -->
                            ...
                            <!-- Start pagination -->
                        <?php
                            $queryForPage = "SELECT * FROM post WHERE author = {$auth_id};";
                            ...
                            if(mysqli_num_rows($pageResult) > 0){
                                ...
                                echo '<ul class="pagination admin-pagination">';
                                    if($page > 1){
                                        echo '<li> <a href="author.php?auth='.$auth_id.'&page='.($page - 1).'"><</a></li>';
                                    }
                                for($i=1; $i<=$totalPage; $i++){
                                    ...
                                    echo '<li class="'.$active.'"><a href="author.php?auth='.$auth_id.'&page='. $i. ' "> '. $i. '</a></li>' ;
